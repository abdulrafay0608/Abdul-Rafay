            ...
            <div className="py-12">
                ...
                <div className="container px-5 py-16 mx-auto">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                        <div className="p-4 md:p-8 flex flex-col rounded-xl border-4 border-double border-yellow-400/50 shadow-lg shadow-yellow-400/50 hover:shadow-slate-400/50 transition ease-in-out delay-75 hover:-translate-y-4 hover:bg-slate-900 hover:scale-100 duration-500">
                            <div className="w-20 h-20 text-5xl inline-flex items-center justify-center rounded-full border-dotted border-yellow-400 border-2 text-yellow-400 mb-5 flex-shrink-0">
                            <FaLaptopCode />
                            </div>
                            <div className="flex-grow">
                                <h2 className="text-yellow-300 text-lg font-bold mb-3">Front-End Developing</h2>
                        ...
                        <div className="p-4 md:p-8 flex flex-col rounded-xl border-4 border-double border-yellow-400/50 shadow-lg shadow-yellow-400/50 hover:shadow-slate-400/50 transition ease-in-out delay-75 hover:-translate-y-4 hover:bg-slate-900 hover:scale-100 duration-500">
                            ...
                            <div className="flex-grow">
                                <h2 className="text-yellow-300 text-lg font-bold mb-3">Web Development</h2>
                                <p className="leading-relaxed text-sm">
                        ...
                        <div className="p-4 md:p-8 flex flex-col rounded-xl border-4 border-double border-yellow-400/50 shadow-lg shadow-yellow-400/50 hover:shadow-slate-400/50 transition ease-in-out delay-75 hover:-translate-y-4 hover:bg-slate-900 hover:scale-100 duration-500">
                            ...
                            <div className="flex-grow">
                                <h2 className="text-yellow-300 text-lg font-bold mb-3">App Development</h2>
                                <p className="leading-relaxed text-sm">
