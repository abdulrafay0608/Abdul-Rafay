      ...
      <div className="min-h-[90vh] relative flex flex-col lg:flex-row justify-around items-center">
        ...
        <div className="md:order-1">
          <div className="md:max-w-[550px] w-full px-3 text-sm leading-7">
            <p>
              Hello! I&apos;m Abdul Rafay, a front-end web developer with a
              passion for creating dynamic and responsive websites. With a
              strong foundation in HTML, CSS, JavaScript, and React (including
