...
const About = () => {
    return (
        <section className='bg-slate-900 py-12 md:p-12' id='about'>
            ...
            <div className='flex flex-col md:flex-row justify-evenly items-center md:mx-16'>
                <div className='shadow-2xl shadow-white/50 rounded-md m-6 md:order-2'>
                    <Image className='rounded-lg' src={"/assets/picture2.jpg"} height={350} width={350} alt='My Picture' />
                </div>
                <div className='md:order-1 md:w-2/3 mx-3 py-2'>
                    <h2 className='md:text-3xl text-2xl font-extrabold my-4'>I&apos;m <span className='text-yellow-400'>Abdul Rafay</span>  &amp; I&apos;m a <span className='text-yellow-400'>Front-End Developer</span> </h2>
